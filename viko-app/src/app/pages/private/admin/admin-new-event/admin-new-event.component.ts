...
import { AdminCreateEventDto, LanguagesObjectFormat } from '../../../../interfaces/interfaces';
...
@Component({
  ...
  styleUrl: './admin-new-event.component.scss'
})
export class AdminNewEventComponent {
  ...
  private saveNewEvent() {
    ...
    const dto: AdminCreateEventDto = {
      Title: this.eventForm.get('title')?.value,
      Image: this.previewUrl?.toString(),
      Teacher: Number(this.eventForm.get('teacher')?.value),
  ...
  onSubmit() {
    ...
    this.eventService.adminCreateEvent(this.saveNewEvent()).subscribe({
      next: (res) => {
